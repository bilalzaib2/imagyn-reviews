...
// flag of its own (Store.aiSummaryOnStoreReviewsEnabled/aiSummaryOnCarouselEnabled/
// aiSummaryOnReviewSiteEnabled gate those OTHER surfaces, not this one) — a merchant adding
// or removing this block in the Theme Editor
